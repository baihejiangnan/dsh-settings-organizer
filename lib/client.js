  ...
  factory: function (require) {
    ...
    function load() {
      try {
        ...
        if (!x || x.version !== 2) return copy(DEFAULT);
    ...
    function Editor2() {
      ...
      function pages() {
        ...
        var result = n
          ...
          : [];
        if (result.length && !state.originalPages.length) {
          var snapshot = copy(state);
          snapshot.originalPages = result.slice();
          save(snapshot);
        }
        return result;
      }
