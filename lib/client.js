window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function navCss() {
      var s = document.createElement("style");
      s.textContent =
        ".dsho-organized{overflow-y:auto;scrollbar-gutter:stable}.dsho-nav-head{width:100%;box-sizing:border-box;border:0;background:transparent;text-align:left;padding:9px 16px;color:#697386;font-size:13px;font-weight:600;cursor:pointer}.dsho-managed-row{padding-left:28px!important}.dsho-nav-head[hidden],.dsho-managed-row[hidden]{display:none!important}.dsho-nav-head:hover{background:rgba(37,99,235,.06)}";
      document.head.appendChild(s);
    }
    function move(id, d) {
      var a = copy(state);
